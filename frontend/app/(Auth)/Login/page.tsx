...
export default function LoginPage() {
    ...
    // Sesión ya activa: no tiene sentido mostrarse el login
    useEffect(() => {
        if (user) router.replace("/");
    }, [user, router]);

    const handleNavigateToRegistro = (e: React.MouseEvent) => {
        e.preventDefault();
                            ...
                            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                                ...
                                <div className="px-7 pt-6 pb-4">
                                    ...
                                    <div className="text-right mb-4">
                                        <button
                                            type="button"
                                            className="text-violet-500 text-xs hover:text-violet-700 transition-colors"
                                        >
